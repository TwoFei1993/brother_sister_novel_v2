...
exports.mergeSubtitleFiles = mergeSubtitleFiles;
// 自定义错误类
 ...
 */
function mergeSubtitleFiles(subtitleFiles, gap = 0) {
    ...
    try {
        ...
        throw new SubtitleMergeError(`Failed to merge subtitles: ${error.message}`);
    }
}
// 辅助函数：验证字幕项格式
function isValidSubtitleItem(item) {
    return (item != null &&
        typeof item === 'object' &&
