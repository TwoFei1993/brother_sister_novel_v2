...
function runEdgeTTS(params) {
    return new Promise((resolve, reject) => {
        ...
        logger_1.logger.info(`run with : edge-tts --text ${params.text.slice(0, 10) + '...'} --voice ${params.voice}  --volume=${params.volume} --pitch=${params.pitch} --rate=${params.rate} --write-media ${params.output}`);
