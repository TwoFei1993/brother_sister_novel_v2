...
const Index = () => {
  ...
  const tts = useTTS(handleTTSChapterEnd);
  ...
  const handleCompleteNovel = useCallback(async () => {
    const lengthMap: Record<string, number> = { trial: 3, short: 8, medium: 15, long: 10 };
    const totalChapters = lengthMap[settings.lengthType] || 10;
